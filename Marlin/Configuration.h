...
#define STRING_CONFIG_H_AUTHOR "(Lokesh, Robo 3D R1 config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Robo R1
  #define DEFAULT_Kp 28.26
  #define DEFAULT_Ki 1.81
  #define DEFAULT_Kd 110.58
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Robo R1
  #define DEFAULT_bedKp 118.21
  #define DEFAULT_bedKi 21.22
  #define DEFAULT_bedKd 438.98
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.95}
